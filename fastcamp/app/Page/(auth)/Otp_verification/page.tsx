      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-[#000523]  via-[#020833]  to-[#000523]  text-white px-16 py-12">
        <div className="flex flex-col justify-between w-full">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm">Fastcamp — แพลตฟอร์มรวมค่าย IT สมัครง่าย โปรโมชั่นที่ใช่ให้คุณเห็นมากขึ้น</p>
          </div>
        </div>
      </div>
      {/* RIGHT SIDE */}
      <div className="w-full lg:w-1/2  bg-[#f5f7fb] flex items-center justify-center relative">
        ...
        <div className="w-full max-w-[420px] flex flex-col items-start">
          <div>
            ...
            {/* subtitle */}
            <p className=" text-gray-500 text-sm mb-8 text-center">Check your email to see the verification code</p>
          </div>
         ...
         <div className="flex gap-4 mb-8">
          ...
          {/* button */}
          <button className="w-full py-3 rounded-full text-white font-medium bg-gradient-to-r  from-[#4f46e5]  to-[#4338ca] hover:opacity-90 transition mb-6">Verify</button>
          {/* resend */}
          <p className="text-sm text-gray-500">Resend code in{" "} <span className="text-indigo-600 font-medium">00:59</span></p>
        </div>
      </div>
    </div>
  )
