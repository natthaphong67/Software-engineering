...
const Category = () => {
  return (
    <div>
      {/* Hero */}
      <div className="relative mt-7 mx-auto max-w-[97%] aspect-[1866/918] overflow-hidden rounded-4xl bg-gradient-to-r from-[#280C3C] via-[#000523] to-[#003376]">
        {/* TEXT */}
            ...
            <div className="w-full md:w-auto shrink-0">
              ...
              <div className="flex flex-col gap-3 md:gap-5">
                {[
                  ...
                  "พัฒนาการ/เวิร์กชอป",
                  "แนะแนวคณะ/อาชีพ",
                  "เสวนา/สัมนา/ทอล์คโชว์",
                  "ประกวดแข่งขัน",
                ].map((text, i) => (
                  <button
                    key={i}
                    className={`h-11 md:h-12 w-full md:w-[360px] rounded-2xl border text-sm md:text-base ${
                      i === 0 ? "bg-[#1B2044] text-white" : ""
                    }`}
                  >
                    {text}
                  </button>
            ...
            <div className="w-full flex flex-col gap-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                {[
                  ...
                  <div
                    key={i}
                    className="relative w-full h-[220px] md:h-[300px] overflow-hidden rounded-xl"
                  >
              ...
              {/* Pagination — อยู่ใต้กริดรูปภาพ ชิดขวา */}
      ...
      <div className="w-full bg-white py-6 md:py-10">
        <div className="mx-auto w-full max-w-7xl rounded-3xl bg-gradient-to-r from-[#220163] to-[#074C89] p-3">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 rounded-2xl border border-white/40 px-5 py-6 md:px-10 md:py-8">
            ...
            {/* BUTTON */}
            <button className="w-full md:w-auto shrink-0 rounded-full border border-white/70 px-6 py-3 md:px-8 md:py-3 text-sm md:text-base text-white hover:bg-white hover:text-[#5B3F8C] transition">
              ส่งกิจกรรมขึ้นเว็บ
            </button>
          </div>
        </div>
