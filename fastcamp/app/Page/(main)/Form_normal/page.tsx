    ...
    <div>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-[#1B2044] font-bold text-3xl md:text-4xl">
            ส่งข้อมูลกิจกรรมประกวดแข่งขัน
          </h1>
          <p className="text-gray-500 mt-3 max-w-3xl">
            สำหรับผู้จัดกิจกรรมที่ต้องการแจ้งข้อมูลการแข่งขัน กิจกรรมประกวด
            หรือโครงการที่มีการมอบรางวัล เพื่อนำไปเผยแพร่และประชาสัมพันธ์ผ่านช่องทางขอ
            ...
            <div className="flex-1">
              ...
              <div className="w-full max-w-[820px] mb-16">
                ...
                <p className="text-gray-400 mt-2 mb-6 text-sm sm:text-base">
                  ส่วนนี้ใช้สำหรับกรอกข้อความพาดหัวและแนบรูปภาพประกอบกิจกรรม
                </p>
                <div className="w-full max-w-[820px] bg-gray-100 border border-gray-300 p-8 rounded-2xl">
                  {/* INPUT */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      <p className="text-[#1B2044] font-semibold mb-2 text-sm">
                        Activity Name<span className="text-[#1B2044] font-normal ml-1">(ชื่อกิจกรรม)</span>
                      </p>
                      <input
                        placeholder="กรอกชื่อกิจกรรม"
                        className="placeholder:text-xs placeholder:text-gray-400 w-[308px] h-[30px] px-3 border bg-white border-gray-300 rounded-md text-sm"
                      />
                    </div>
                    <div className="w-full max-w-[500px]">
                      <p className="text-[#1B2044] font-semibold mb-2 text-sm">
                        Tagline<span className="text-[#1B2044] font-normal ml-1">(คำโปรยแนะนำกิจกรรม)</span>
                      </p>
                      <input
                        placeholder="ข้อความสั้น ๆ ที่ใช้แนะนำกิจกรรมให้เข้าใจง่าย"
                        className="w-full h-[33px] bg-white px-4 border border-gray-300 rounded-lg text-sm placeholder:text-xs placeholder:text-gray-400"
                      />
                    </div>
                  </div>
                  {/* ACTIVITY TYPE */}
                  <div className="mt-8">
                    <p className="text-[#1B2044] font-semibold mb-4 text-sm">
                      Activity Type<span className="text-[#1B2044] font-normal ml-1">(ประเภทของกิจกรรม)</span>
                    </p>
                  ...
                  <div className="mt-8">
                    <p className="text-[#1B2044] font-semibold mb-4 text-sm">
                      Headline Image<span className="text-gray-400 font-normal ml-1">(ภาพสำหรับประชาสัมพันธ์)</span>
                    </p>
              ...
              <div className="w-full max-w-[820px] mb-16">
                ...
                <div className="bg-[#F4F4F4] border border-gray-300 p-4 sm:p-6 md:p-8 rounded-2xl space-y-8">
                  ...
                  <div className="w-max">
                    ...
                    <input
                      placeholder="หากกิจกรรมฟรี ไม่ต้องกรอกราคา และเลือก ฟรีด้านล่าง"
