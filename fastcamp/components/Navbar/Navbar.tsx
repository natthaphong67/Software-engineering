...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { name: "ส่งกิจกรรมขึ้นเว็บ", href: "/Page/Form_normal" },
  ];
  ...
  return (
    <nav className={`absolute border-b border-white/5 px-10 py-4 flex items-center justify-between  top-0 left-0 right-0 z-50 ${bgClass}`}>  
      ...
      <div className="relative" ref={popupRef}>
        ...
        {popupOpen && (
          <div className="absolute right-0 mt-4 w-80 bg-white rounded-2xl shadow-2xl overflow-hidden z-50 animate-fade-in">
            ...
            {/* Edit Profile */}
            <Link href="/Page/EditProfile" className="w-full flex items-center justify-between px-4 py-3.5 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors group">
            ...
            {/* Settings */}
            <Link href="/Page/EditProfile" className="w-full flex items-center justify-between px-4 py-3.5 rounded-xl hover:bg-gray-50 transition-colors">
              <div className="flex items-center gap-4">
                <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
            ...
            {/* Log Out */}
            <Link href="/Page/Login" className="w-full flex items-center gap-4 px-4 py-3.5 rounded-xl hover:bg-gray-50 transition-colors">
              <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
